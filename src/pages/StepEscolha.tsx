          ...
          <div className="space-y-4 max-w-md mx-auto lg:max-w-none">
            ...
            >
              ...
              <div className="min-w-0 flex items-center gap-2 flex-wrap">
                ...
                <p className="text-[11px] leading-relaxed" style={{ color: 'rgba(160,220,170,0.65)' }}>
                  Aceito receber novidades e ofertas exclusivas do Select Motel pelo WhatsApp.
                </p>
                <span className="text-[10px] px-1.5 py-0.5 rounded-full shrink-0" style={{ background: 'rgba(37,211,102,0.1)', color: 'rgba(37,211,102,0.55)', border: '1px solid rgba(37,211,102,0.2)' }}>
                  opcional
                </span>
              </div>
            </label>

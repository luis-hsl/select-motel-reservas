            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5 mb-0.5">
                  ...
                  <span className="text-[11px] font-semibold tracking-wide" style={{ color: 'rgba(37,211,102,0.85)' }}>
                    Receber ofertas pelo WhatsApp
                  </span>
                  <span className="text-[10px] px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(37,211,102,0.1)', color: 'rgba(37,211,102,0.55)', border: '1px solid rgba(37,211,102,0.2)' }}>
                    opcional
                  </span>
                </div>
                <p className="text-[11px] leading-relaxed" style={{ color: 'rgba(160,220,170,0.55)' }}>
                  Aceito receber novidades e ofertas exclusivas do Select Motel pelo WhatsApp.
                </p>
              </div>
            </label>

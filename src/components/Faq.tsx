...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a:
      'Sim. Após escolher o pacote, você vê todas as suítes daquela categoria — VIP com piscina, Suíte Hidro, Hidro Light ou Tradicional — com fotos e vídeo de cada uma para escolher a sua favorita.',
  },
  {

...
export const SUITES: Suite[] = [
  ...
  { id: 'suite-15', name: 'Suíte 15', category: 'Hidro', description: 'Suíte Hidro com hidromassagem e 2 quartos', room_number: 15, size: 'large', cleaning_buffer_h: 1, packageIds: ['prata'] },
  { id: 'suite-16', name: 'Suíte 16', category: 'Hidro', description: 'Suíte Hidro com hidromassagem e 2 quartos', room_number: 16, size: 'large', cleaning_buffer_h: 1, packageIds: ['prata'] },
  { id: 'suite-17', name: 'Suíte 17', category: 'Hidro', description: 'Suíte Hidro com hidromassagem e 2 quartos', room_number: 17, size: 'large', cleaning_buffer_h: 1, packageIds: ['prata'] },
  { id: 'suite-18', name: 'Suíte 18', category: 'Hidro', description: 'Suíte Hidro com hidromassagem e 2 quartos', room_number: 18, size: 'large', cleaning_buffer_h: 1, packageIds: ['prata'] },
